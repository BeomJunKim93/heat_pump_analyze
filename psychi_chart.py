...
t_array = np.arange(0,45,0.1)
rh_array = np.arange(0,1.1,0.1)
enthalpy_array = np.arange(0,12000,10000)
hr_hor_lines = np.arange(0.005,0.03,0.005)
twb_array = np.arange(-20,45,5)
...
ax.set(ylim=(0, 0.035), xlim=(0,40), ylabel=r"Humidity Ratio [$kg_(water)/kg_(dry air)$]", xlabel="Dry-bulb Temperature [°C]")
ax.yaxis.tick_right()
...
custom_style = {
    ...
    "constant_h": {"color": [0.4, 0.4, 0.0], "linewidth": 0.75, "linestyle": "-"},
